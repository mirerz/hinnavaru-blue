/*
  ===== HINNAVARU BLUE ΓÇö INDEPENDENT LIVE PROJECT =====
  Author: Miraz (P.729)
...
export const DOCUMENT_VAULTS = [
  { icon: '≡ƒô£', title: 'NGO Registration Certificate', type: 'Official License', date: 'Feb 2026', category: 'Admin' },
  { icon: '≡ƒº¼', title: 'Restoration Genetics Guide', type: 'Scientific Guide', date: '2026', category: 'Awareness', path: '/media-hub/A_restoration_genetics_guide_for_coral_reef_conservation.pdf' },
  { icon: '≡ƒôÜ', title: 'Coral Restoration Terminologies', type: 'Educational', date: '2026', category: 'Awareness', path: '/media-hub/A_userΓÇÖs_guide_to_coral_reef_restoration_terminologies.pdf' },
  { icon: '≡ƒîè', title: 'Coastal Resilience Handbook', type: 'Education', date: '2026', category: 'Awareness' },
  { icon: '≡ƒ¬╕', title: 'Quarterly Impact Assessment', type: 'Data Report', date: 'Mar 2026', category: 'Admin' },
]

// 4. THE NOTICE BOARD (Live Feed Updates)
export const LATEST_BULLETINS = [
  { icon: '≡ƒôÜ', type: 'New Document', text: 'Official User Guide to Coral Restoration Terminologies published. Read now in the Vault.' },
  { icon: '≡ƒº¼', type: 'Science', text: 'Restoration Genetics Guide updated with heat-tolerant species metrics.' },
  { icon: '≡ƒîì', type: 'Global', text: 'UN Ocean Decade target aligned: Hinnavaru blueprint scaling to 14 atolls.' },
  { icon: '≡ƒôí', type: 'Live Feed', text: 'Global network detects 0.2┬░C temp anomaly. High-frequency monitoring activated.' },
  { icon: '≡ƒîè', type: 'Mission', text: 'Vision 2030: Restoring critical nursery corridors for 5,000+ localized reef species.' },
  { icon: '≡ƒôó', type: 'Milestone', text: 'Operational milestone passed! 100% of global funding allocated directly to field operations.' },
  { icon: '≡ƒ¬╕', type: 'Data', text: 'March survival rates show 82% healthy coverage across 180 tracked frames.' }
]
...
export const APPROVED_GUARDIANS = [
  { id: 'GD-00', name: 'Mirror', role: 'Initiator', avatar: '≡ƒæü∩╕Å', telegramId: '1116569241' },
  { id: 'GD-01', name: 'Nabeel Hussain', role: 'Lead Diver', avatar: '≡ƒñ┐', telegramId: '1305116955' },
  { id: 'GD-02', name: 'Zoya Ahmed', role: 'Initiator', avatar: '≡ƒæ⌐ΓÇì≡ƒö¼', telegramId: '8594545357' },
  { id: 'GD-03', name: 'Ibrahim Ali', role: 'Initiator', avatar: '≡ƒîè', telegramId: '8594545357' },
]
...
export const PROJECT_CATEGORIES = [
  { id: 'coral', title: 'Coral Restoration', slug: 'restoration', emoji: '≡ƒ¬╕' },
  { id: 'sweep', title: 'Sweep Efforts', slug: 'sweep', emoji: '≡ƒº╣' },
  { id: 'edu', title: 'Edu Awareness', slug: 'education', emoji: '≡ƒôÜ' },
]
...
export const PROJECTS_LIST = [
  {
    ...
    actionPrimary: '≡ƒñ┐ Join Next Dive',
    actionPrimaryDone: 'Γ£à Registered!',
    actionSecondary: '≡ƒô╕ View Latest Photos',
  ...
  },
  {
    ...
    actionPrimary: '≡ƒö¼ Volunteer in Lab',
    actionPrimaryDone: 'Γ£à Volunteered!',
    actionSecondary: '≡ƒôï View Research Notes',
    actionSecondaryLink: '#archive'
  },
  {
    category: 'edu',
    ...
    actionPrimary: '≡ƒÄÆ Enroll Student',
    actionPrimaryDone: 'Γ£à Enrolled!',
    actionSecondary: '≡ƒû╝∩╕Å View Event Gallery',
    actionSecondaryLink: '#archive'
  },
  {
    category: 'coral',
    ...
    actionPrimary: '≡ƒôí Fund a Buoy',
    actionPrimaryDone: 'Γ£à Pledged!',
    actionSecondary: '≡ƒôï Technical Specs',
  ...
  },
  {
    ...
    actionPrimary: '≡ƒº╣ Volunteer',
    actionPrimaryDone: 'Γ£à Signed Up!',
    actionSecondary: '≡ƒôè Impact Data',
    actionSecondaryLink: '#registry'
  },
  {
...
export const ABOUT_CONTENT = {
  ...
  narrative: {
    ...
    shipyard: {
      ...
      vessels: [
        { name: "Skipjack II (The Sentinel)", desc: "The siteΓÇÖs most iconic feature. Originally a vessel for the Felivaru fish factory, it was meant to be scuttled in 1985. However, it caught fire and sank stern-first, leaving its bow protruding vertically out of the waterΓÇöa rusted North Star for every Hinnavarian traveler." },
    ...
    catalyst: {
      ...
      p1: "Our commitment to this site was born from the intersection of industry and tragedy. In 2004, our veteran fishermenΓÇömen who had spent their lives navigating the Felivaru fleetΓÇönoticed alarming changes in the sea levels at their ancestral grounds.",
      p2: "For the families living near the Harbor Jetty, the December Tsunami was a defining moment of trauma. It forced a realization that changed our community forever: our islandΓÇÖs survival is inextricably linked to the health of our reef.",
    ...
    model: {
      ...
      p1: "Rather than waiting for outside intervention, the family combined their technical ingenuity with marine science. Their brainstorming led to the islandΓÇÖs first coral nurseryΓÇöusing repurposed boat frames to turn the tools of their seafaring trade into the cradles of a restored ecosystem.",
      ...
      bullets: [
        ...
        { label: "The Northern Blueprint", text: "Our modelΓÇöcombining community ownership with open dataΓÇöis now being studied for expansion across the Noonu, Raa, Baa, and Lhaviyani Atolls." }
      ],
    ...
    footer_quote: "By protecting the Shipyard and scaling the Hinnavaru Blue model, we aren't just saving two old shipsΓÇöwe are securing the heart of the Maldives.",
...
export const PILLARS = [
  { icon: '≡ƒñ¥', title: 'Ekuveri', sub: 'Unity', text: 'Fostering shared ownership through inclusive education. We believe restoration succeeds only when we act as one community.' },
  { icon: '≡ƒö¼', title: 'Ilmu', sub: 'Knowledge', text: 'Blending ancestral Maldivian sea-wisdom with cutting-edge marine science to drive every restoration decision we make.' },
  { icon: '≡ƒÅ¢∩╕Å', title: 'Amaanaiy', sub: 'Integrity', text: 'Absolute transparency in data, community interactions, and funding execution. We are accountable to the reef.' },
  { icon: '≡ƒº¼', title: 'Tharika', sub: 'Legacy', text: 'Protecting natural capital and preserving our thriving ecosystem to ensure the reefs are there for the generations of tomorrow.' },
  { icon: '≡ƒ½Ç', title: 'Vindhu', sub: 'Vitality', text: 'Recognizing the reef as the pulse of Hinnavaru. We prioritize the health of the lagoon as our islandΓÇÖs absolute heartbeat.' },
]
...
export const HOME_CONTENT = {
  ...
  mission_strip: {
    quote: "The sea is not separate from us ΓÇö it is us. Hinnavaru has lived by the lagoon for generations, and it is our duty to ensure it thrives for generations to come.",
    author: "Ahmed Nabeel Hussain Didi, Founder",
    p1: "We believe that lasting ocean conservation is only possible when local communities are at the heart of it ΓÇö as scientists, guardians, and storytellers.",
...
export const REGISTRY_CONTENT = {
  ...
  transparency: {
    ...
    funds: {
      title: "≡ƒÆ░ Deployment Success Rate (2025)",
      total: "Avg. Frame Survival: 82% Nationwide"
    },
    docs: {
      title: "≡ƒôü Official Documents",
      desc: "All certificates, audits, and reports ΓÇö available to view or upon request."
    }
  }
}
