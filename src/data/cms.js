...
export const CORAL_REGISTRY = [
  ...
  { id: 'HBF-097', species: 'Pocillopora eydouxi', location: 'North Lagoon, Zone A', depth: '6m', adopter: 'Ali Naseer Fam', date: '2026-03-10', status: 'healthy', survival: 94, lat: 5.4914, lng: 73.4061 },
...
export const LAGOON_STORIES = [
  {
    ...
    "expiryDate": "2026-07-13T13:47:55.970Z"
  },
  {
    "id": "DRIVE-1",
    "type": "photo",
    ...
    "expiryDate": "2026-07-13T13:47:55.971Z"
  },
  {
    "id": "DRIVE-2",
    "type": "photo",
  ...
  },
  {
    ...
    "guardianId": "GD-00",
    "timestamp": "2026-04-15T16:32:07.000Z",
    "expiryDate": "2026-07-13T13:47:55.972Z"
  },
  {
    "id": "DRIVE-6",
    "type": "photo",
...
export const PROJECTS_LIST = [
  {
    ...
    title: 'Adopt Batch 1',
    folderPath: '/Adopt/AX1',
    desc: 'The inaugural batch placed on 10th February 2026. 10 Frames deployed with a survival rate of 40/50 corals per frame.',
    progress: 80,
    progressLabel: '80% Survival Target Met',
    actionPrimary: '🔬 View Stats',
    actionPrimaryDone: '✅ Viewed',
    actionSecondary: '🖼️ Field Notes',
  ...
  },
  {
    ...
    badgeClass: 'badge-teal',
    title: 'Adopt Batch 2',
    folderPath: '/Adopt/AX2',
    desc: 'Placed on April 10th 2026. 10 Frames (Survived 50 Corals) successfully deployed into the lagoon nursery.',
    progress: 100,
    progressLabel: '100% Deployed',
    actionPrimary: '🤿 Log Dive',
    actionPrimaryDone: '✅ Logged!',
    actionSecondary: '📸 View Photos',
    actionSecondaryLink: '#archive'
  },
  {
    category: 'coral',
    ...
    title: 'Adopt Batch 3',
    folderPath: '/Adopt/AX3',
    desc: 'Scheduled for mid-2026. This next expansion will focus on high-diversity species and deep-lagoon temperature monitoring.',
    progress: 0,
    progressLabel: 'Opening Soon',
    actionPrimary: '✉️ Get Notified',
    actionPrimaryDone: '✅ Notified!',
    actionSecondary: '📋 Batch Info',
  ...
  },
  {
    ...
    badgeClass: 'badge-teal',
    title: 'Sweep Phase 1',
    folderPath: '/Sweep/SX1',
    desc: 'Held on March 6th 2026. First community-led harbor and shipyard cleanup targeting significant marine debris removal.',
    progress: 100,
    progressLabel: '100% Completed',
    actionPrimary: '📊 View Impact',
    actionPrimaryDone: '✅ Viewed',
    actionSecondary: '🎥 Round Video',
    actionSecondaryLink: '#archive'
  },
  {
    category: 'sweep',
    ...
    badgeClass: 'badge-coral',
    title: 'Sweep Phase 2',
    folderPath: '/Sweep/SX2',
    desc: 'Upcoming debris extraction phase. Focusing on the southern lagoon channels and plastic waste hotspots.',
    progress: 0,
    progressLabel: 'Planning Phase',
    actionPrimary: '🧹 Volunteer',
    actionPrimaryDone: '✅ Signed Up!',
    actionSecondary: '🗺️ Sweep Map',
    actionSecondaryLink: '#registry'
  },
  {
    category: 'sweep',
    ...
    badgeClass: 'badge-coral',
    title: 'Sweep Phase 3',
    folderPath: '/Sweep/SX3',
    desc: 'Targeting derelict fishing gear (ghost nets) around the shipyard wrecks. Expected Q4.',
    progress: 0,
    progressLabel: 'Projected Q4',
    actionPrimary: '⚓ Join Crew',
    actionPrimaryDone: '✅ Joined',
    actionSecondary: '📋 Safety Specs',
    actionSecondaryLink: '#registry'
  },
  {
    category: 'edu',
    ...
    title: 'Edu Batch 1',
    folderPath: '/Edu/EX1',
    desc: 'Held on May 1st. First Edu Aware session featuring Flyer and Coral Restoration Readings materials distribution.',
    progress: 100,
    progressLabel: '100% Session Complete',
    actionPrimary: '🎒 View Materials',
    actionPrimaryDone: '✅ Downloaded',
    actionSecondary: '🖼️ Gallery',
    actionSecondaryLink: '#archive'
  },
  {
    category: 'edu',
    ...
    title: 'Edu Batch 2',
    folderPath: '/Edu/EX2',
    desc: 'Advanced stewards program focusing on coral fragmentation techniques and nursery maintenance.',
    progress: 0,
    progressLabel: 'Planned',
    actionPrimary: '🎒 Inquire',
    actionPrimaryDone: '✅ Sent',
    actionSecondary: '📋 Curriculum',
    actionSecondaryLink: '#archive'
  },
  {
    category: 'edu',
    ...
    title: 'Edu Batch 3',
    folderPath: '/Edu/EX3',
    desc: 'International partnership group for visiting researchers and conservation students.',
    progress: 0,
    progressLabel: 'Planned',
    actionPrimary: '✉️ Notify Me',
    actionPrimaryDone: '✅ Notified',
    actionSecondary: '📋 Program Info',
    actionSecondaryLink: '#archive'
  }
]
